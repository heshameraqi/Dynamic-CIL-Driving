...
lat_noise_percent = 95
long_noise_percent = 50
NumberOfVehicles = [30, 60]  # default: 30, 60. The range for the random numbers that are going to be generated
NumberOfPedestrians = [50, 100]  # default: 50, 100
...
def make_carla_settings():
    ...
    lidar.set(
        Channels=32,
        Range=50,
        PointsPerSecond=150000,  # 100000 if fps=10, 150000 if fps=15, TODO: this should be dynamic
        RotationFrequency=15,  # Should be equal to FPS, TODO: this should be dynamic
        UpperFovLimit=10,
        LowerFovLimit=-30)
