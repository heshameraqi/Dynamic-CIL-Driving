...
class CarlaMap(object):
    ...
    def __init__(self, city, pixel_density, node_density):
        ...
        plt.subplot(2, 2, 1)
        plt.gca().set_title("Grid Map")
        plt.imshow(self._grid._structure)
        plt.subplot(2, 2, 2)
        plt.gca().set_title("World Map")
        plt.imshow(self.map_image)
        plt.subplot(2, 2, 3)
        plt.gca().set_title("World Map Lanes")
        plt.imshow(self.map_image_lanes)
        plt.subplot(2, 2, 4)
        plt.gca().set_title("World Map Centres")
        plt.imshow(self.map_image_center)"""
