...
def print_summary(metrics_summary, weathers, path):
    ...
    for metric in metrics_to_average:
        ...
        for i in range(len(metric_sum_values)):
            print('    Task ', i, ' -> ', round(metric_sum_values[i]*100, 2))
        print("")
    ...
    for metric in infraction_metrics:
        ...
        if metric_sum_values[i] == 0:
            print('    Task Dynamic Nav ', i, ' -> more than ', round(summed_driven_kilometers[i], 2))
        else:
            print('    Task Dynamic Nav ', i, ' -> ', round(summed_driven_kilometers[i] / metric_sum_values[i], 2))
        print("")
